...
#define sec_in32(a)       readl(a)
#define sec_out32(a, v)   writel(a, v)
#define sec_in16(a)       read16(a)

#define jr_in32(a)	readl(a)
#define jr_out32(a,v)	writel(a,v)
